...
object KeyboardThemeApplicator {
    ...
    fun builtInSpec(theme: String): Spec = when (theme) {
        ...
        "핑크" -> Spec(
            ...
            suggestionBackground = Color.parseColor("#D8E2FF"),
            ...
            letterText = Color.parseColor("#2C333D"),
            letterSubText = Color.parseColor("#838A95"),
            numberFill = Color.WHITE,
            numberPressedFill = Color.parseColor("#ECEFF7"),
            numberText = Color.parseColor("#2C333D"),
            functionFill = Color.parseColor("#E0E2E8"),
            functionPressedFill = Color.parseColor("#D5D9E1"),
            functionText = Color.parseColor("#2C333D"),
            functionIconTint = Color.parseColor("#2C333D"),
            secondaryIconTint = Color.parseColor("#595F6A"),
            spaceFill = Color.WHITE,
            spacePressedFill = Color.parseColor("#ECEFF7"),
            spaceText = Color.parseColor("#8A8F99"),
